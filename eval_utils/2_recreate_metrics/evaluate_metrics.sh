...
#SBATCH --output=/scratch/gilbreth/li5042/transkun/transkun_fork/eval_utils/2_recreate_metrics/output/evaluate_metrics.log.out
#SBATCH --error=/scratch/gilbreth/li5042/transkun/transkun_fork/eval_utils/2_recreate_metrics/output/evaluate_metrics.log.err

#===========================================
#run command: 
# sbatch /scratch/gilbreth/li5042/transkun/transkun_fork/eval_utils/2_recreate_metrics/evaluate_metrics.sh
